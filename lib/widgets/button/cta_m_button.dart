...
class CtaM extends StatelessWidget {
  final String text;
  ...
  Widget build(BuildContext context) {
    return CustomButton(
      ...
      textStyle: AppTextStyles.ctaMBold(context),
  ...
  double _getHeight(BuildContext context) {
    ...
    switch (deviceType) {
      case DeviceType.mobile:
        return AppSizes.mobileHeightM;
      case DeviceType.tablet:
        return AppSizes.tabletHeightM;
      case DeviceType.desktop:
        return AppSizes.desktopHeightM;
    }
  }
}