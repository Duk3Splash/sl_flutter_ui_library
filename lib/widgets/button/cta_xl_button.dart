...
class CtaXL extends StatelessWidget {
  final String text;
  ...
  Widget build(BuildContext context) {
    return CustomButton(
      ...
      textStyle: AppTextStyles.ctaXLBold(context),
  ...
  double _getHeight(BuildContext context) {
    ...
    switch (deviceType) {
      case DeviceType.mobile:
        return AppSizes.mobileHeightXL;
      case DeviceType.tablet:
        return AppSizes.tabletHeightXL;
      case DeviceType.desktop:
        return AppSizes.desktopHeightXL;
    }
  }
}